...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(Activity.RESULT_CANCELED);

        // Initialize the button to perform device discpovery
        ...
        //Find and set up listView for newlyDiscovered devices
        ListView newDevicesListView = (ListView) findViewById(R.id.new_devices);
        newDevicesListView.setAdapter(mNewDevicesArrayAdapter);
        newDevicesListView.setOnItemClickListener(mDeviceClickListener);

        // Register for broadcast when discovery is discovered
        ...
        // If there are paired, add each one to the arrayAdapter
